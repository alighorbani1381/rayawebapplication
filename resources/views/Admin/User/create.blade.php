                ...
                <div class="col-lg-11">
                    <form class="form-horizontal" action="{{ route('users.index') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="lastname" class="form-control"placeholder="نام خانوادگی کاربر را وارد کنید ...">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="phone" class="form-control" placeholder="شماره تماس کاربر را وارد کنید ...">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control txt-custom" placeholder="آدرس را وارد کنید ..." name="address" rows="5"></textarea>
                            </div>
                        </div>
                        ...
                        <h4 class="header-title m-t-0 m-b-30">اطلاعات ورود</h4>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="password" class="form-control" placeholder="رمز عبور را وارد کنید ...">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success waves-effect waves-light submit-button">افزودن کاربر</button>
                        </div>
                    </form>
                </div><!-- end col -->
