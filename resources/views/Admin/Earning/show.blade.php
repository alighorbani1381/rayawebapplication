        ...
        <div class="card-box task-detail">
            ...
            <div class="media m-b-20">
                <div class="media-left">
                    <a href="#"> <img class="media-object img-circle" alt="64x64" src="assets/images/users/avatar-2.jpg"
            ...
            <div class="task-tags m-t-20">
                ...
                <input type="text" value="اندروید,طراح واسط کاربری,وردپرس" data-role="tagsinput"
            ...
            <div class="assign-team m-t-30">
                ...
                <div>
                    <a href="#"> <img class="img-circle thumb-sm" alt="64x64" src="assets/images/users/avatar-2.jpg">
                    </a>
                    <a href="#"> <img class="img-circle thumb-sm" alt="64x64" src="assets/images/users/avatar-3.jpg">
                    </a>
                    <a href="#"> <img class="img-circle thumb-sm" alt="64x64" src="assets/images/users/avatar-5.jpg">
                    </a>
                    <a href="#"> <img class="img-circle thumb-sm" alt="64x64" src="assets/images/users/avatar-8.jpg">
                    </a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-right m-t-30">
                            ...
                            <button type="button" class="btn btn-default waves-effect">لغو
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-4">
        <div class="card-box">
            <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="{{ route('projects.show', $earning->project_id) }}">برو به پروژه</a></li>
                </ul>
            </div>
